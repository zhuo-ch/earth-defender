...
/* harmony export (immutable) */ __webpack_exports__["e"] = getStartPos;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = isCollidedWith;
...
class Explosion {
  ...
  isCollidedWith(otherObj) {
    return __WEBPACK_IMPORTED_MODULE_0__util__["d" /* isCollidedWith */](this, otherObj);
  };
...
class Game {
  ...
  playMusic() {
    ...
    window.allAudio.push(this.music);
    this.music.play();
  }
  ...
  startLaser() {
    document.getElementsByClassName('game-display')[0].setAttribute('className', 'laser');
  ...
  draw(ctx) {
    ...
    __WEBPACK_IMPORTED_MODULE_3__util_draw_util__["a" /* drawBar */](ctx, this.score, this.time, this.shields, this.dimX);
    __WEBPACK_IMPORTED_MODULE_3__util_draw_util__["b" /* drawCurrentGun */](ctx, this.currentGun);
    __WEBPACK_IMPORTED_MODULE_3__util_draw_util__["c" /* drawIcons */](ctx, this.images);
    __WEBPACK_IMPORTED_MODULE_3__util_draw_util__["d" /* drawControls */](ctx);
    __WEBPACK_IMPORTED_MODULE_3__util_draw_util__["e" /* drawSound */](ctx, this.images, this.soundOn, this.musicOn);
  }
...
class LaserExplosion {
  ...
  isCollidedWith(otherObj) {
    return __WEBPACK_IMPORTED_MODULE_0__util_util__["d" /* isCollidedWith */](this, otherObj);
  }
...
class Rocket {
  ...
  draw(ctx) {
    ...
    const pos = this.pos;
    const color = this.color;
    const startPos = __WEBPACK_IMPORTED_MODULE_0__util_util__["e" /* getStartPos */](pos, vel, this.endPos);
    __WEBPACK_IMPORTED_MODULE_1__util_draw_util__["f" /* drawProjectile */]({ctx, pos, vel, startPos, color});
  }
...
class Missile {
  ...
  draw(ctx) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["f" /* drawProjectile */]({ctx, pos, vel, startPos, color});
  }
  ...
  explode() {
    ...
    return new __WEBPACK_IMPORTED_MODULE_2__explosion__["a" /* default */]({pos: this.pos, color: this.color, maxRadius});
  }
...
/* harmony export (immutable) */ __webpack_exports__["f"] = drawProjectile;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = drawBar;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = drawCurrentGun;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = drawIcons;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = drawControls;


const drawSound = (ctx, images, soundOn, musicOn) => {
  if (soundOn) {
    ctx.drawImage(images.soundOn, 570, 425, 30, 30);
  } else {
    ctx.drawImage(images.soundOff, 570, 425, 30, 30);
  }

  if (musicOn) {
    ctx.drawImage(images.musicOn, 530, 425, 30, 30);
  } else {
    ctx.drawImage(images.musicOff, 530, 425, 30, 30)
  }
}
/* harmony export (immutable) */ __webpack_exports__["e"] = drawSound;
