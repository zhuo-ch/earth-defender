...
class GameView {
  ...
  endGame() {
    ...
    this.game.music.muted = true;
    this.gameStarted = false;
    this.splashStart(this.ctx, highScores);
  }
...
/* harmony export (immutable) */ __webpack_exports__["i"] = drawProjectile;
...
/* harmony export (immutable) */ __webpack_exports__["j"] = isCollidedWith;
...
/* harmony export (immutable) */ __webpack_exports__["h"] = drawSound;
...
class Explosion {
  ...
  isCollidedWith(otherObj) {
    return __WEBPACK_IMPORTED_MODULE_0__util__["j" /* isCollidedWith */](this, otherObj);
  };
...
class Game {
  ...
  shoot(endPos) {
    ...
    switch (this.currentGun) {
      ...
      case 'ClusterGun':
        if (this.canShoot && endPos[1] < 440) {
          this.projectiles.push(new __WEBPACK_IMPORTED_MODULE_4__guns_cluster_gun__["a" /* default */]({pos, vel, endPos, soundOn}));
      ...
      case 'GravityGun':
        if (this.canShoot) {
          this.projectiles.push(new __WEBPACK_IMPORTED_MODULE_5__guns_gravity_gun__["a" /* default */]({pos, vel, endPos, soundOn}));
      ...
      case 'Laser':
        if (this.canShoot) {
          this.projectiles.push(new __WEBPACK_IMPORTED_MODULE_6__guns_laser__["a" /* default */]({pos, game: this, endPos, bounds: this.bounds, soundOn }));
          this.canShoot = false;
  ...
  draw(ctx) {
    ...
    __WEBPACK_IMPORTED_MODULE_2__util_util__["h" /* drawSound */](ctx, this.images, this.soundOn, this.musicOn);
  }
...
class LaserExplosion {
  ...
  isCollidedWith(otherObj) {
    return __WEBPACK_IMPORTED_MODULE_0__util_util__["j" /* isCollidedWith */](this, otherObj);
  }
...
class Rocket {
  ...
  draw(ctx) {
    ...
    const pos = this.pos;
    const color = this.color;
    const startPos = __WEBPACK_IMPORTED_MODULE_0__util_util__["k" /* getStartPos */](pos, vel, this.endPos);
    __WEBPACK_IMPORTED_MODULE_0__util_util__["i" /* drawProjectile */]({ctx, pos, vel, startPos, color});
  }
...
class Missile {
  ...
  draw(ctx) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__util__["i" /* drawProjectile */]({ctx, pos, vel, startPos, color});
  }
