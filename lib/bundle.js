...
class GameView {
  ...
  endGame() {
    ...
    this.game.nav.music.muted = true;
    this.gameStarted = false;
...
/* harmony export (immutable) */ __webpack_exports__["g"] = getStartPos;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = isCollidedWith;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = getRandomEnd;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = getRandomStart;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = getMissileStart;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = getMissileVel;
...
class Explosion {
  ...
  isCollidedWith(otherObj) {
    return __WEBPACK_IMPORTED_MODULE_0__util__["f" /* isCollidedWith */](this, otherObj);
  };
    ...
    switch (this.nav.currentGun) {
      case 'Rocket':
        if (this.canShoot && endPos[1] < 440) {
          this.projectiles.push(new __WEBPACK_IMPORTED_MODULE_1__guns_rocket__["a" /* default */]({pos, vel, endPos, nav}));
      ...
      case 'ClusterGun':
        if (this.canShoot && endPos[1] < 440) {
          this.projectiles.push(new __WEBPACK_IMPORTED_MODULE_5__guns_cluster_gun__["a" /* default */]({pos, vel, endPos, nav}));
      ...
      case 'GravityGun':
        if (this.canShoot) {
          this.projectiles.push(new __WEBPACK_IMPORTED_MODULE_6__guns_gravity_gun__["a" /* default */]({pos, vel, endPos, nav}));
...
class LaserExplosion {
  ...
  isCollidedWith(otherObj) {
    return __WEBPACK_IMPORTED_MODULE_0__util_util__["f" /* isCollidedWith */](this, otherObj);
  }
...
class Rocket {
  ...
  draw(ctx) {
    ...
    const pos = this.pos;
    const color = this.color;
    const startPos = __WEBPACK_IMPORTED_MODULE_0__util_util__["g" /* getStartPos */](pos, vel, this.endPos);
...
class Missile {
  constructor({ game }) {
    ...
    this.pos = __WEBPACK_IMPORTED_MODULE_0__util__["b" /* getRandomStart */](game.dimX);
    this.endPos = __WEBPACK_IMPORTED_MODULE_0__util__["c" /* getRandomEnd */](game.dimX, game.dimY);
    this.vel = __WEBPACK_IMPORTED_MODULE_0__util__["d" /* getMissileVel */](this.pos, this.endPos, this.constSpeed);
    this.game = game;
    this.maxRadius = 60;
    this.color = 'red';
  }
  ...
  draw(ctx) {
    const startPos = __WEBPACK_IMPORTED_MODULE_0__util__["e" /* getMissileStart */](this.pos, this.vel);
