...
class GameView {
  ...
  initializeImages() {
    ...
    this.images = {background, rocketIcon, shotgunIcon, gravityGunIcon, laserIcon};
  }
...
/* harmony export (immutable) */ __webpack_exports__["g"] = drawProjectile;
...
class Game {
  ...
  draw(ctx) {
    ...
    __WEBPACK_IMPORTED_MODULE_2__util_util__["b" /* drawBar */](ctx, this.score, this.time, this.shields, this.dimX);
    __WEBPACK_IMPORTED_MODULE_2__util_util__["c" /* drawCurrentGun */](ctx, this.currentGun);
    __WEBPACK_IMPORTED_MODULE_2__util_util__["d" /* drawIcons */](ctx, this.images);
    __WEBPACK_IMPORTED_MODULE_2__util_util__["e" /* drawControls */](ctx);
  }
...
class Rocket {
  ...
  draw(ctx) {
    ...
    const vel = this.vel;
    const color = this.color;
    __WEBPACK_IMPORTED_MODULE_0__util_util__["g" /* drawProjectile */]({ctx, pos, vel, color});
  }
...
class Missile {
  ...
  draw(ctx) {
    ...
    const vel = this.vel;
    const color = this.color;
    __WEBPACK_IMPORTED_MODULE_0__util__["g" /* drawProjectile */]({ctx, pos, vel, color});
  }
