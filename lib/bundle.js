...
class Game {
  ...
  draw(ctx) {
    ...
    __WEBPACK_IMPORTED_MODULE_3__util_draw_util__["a" /* drawSound */](ctx, this.images, this.soundOn, this.musicOn);
  }
...
class Rocket {
  ...
  draw(ctx) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__util_draw_util__["b" /* drawProjectile */]({ctx, pos, vel, startPos, color});
  }
...
class Missile {
  ...
  draw(ctx) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__draw_util__["b" /* drawProjectile */]({ctx, pos, vel, startPos, color});
  }
...
/* harmony export (immutable) */ __webpack_exports__["c"] = drawBar;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = drawCurrentGun;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = drawIcons;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = drawControls;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = drawSound;
...
class Nav {
  ...
  draw(ctx, dimX) {
    __WEBPACK_IMPORTED_MODULE_0__util_draw_util__["c" /* drawBar */](ctx, this.score, this.time, this.shields, dimX);
    __WEBPACK_IMPORTED_MODULE_0__util_draw_util__["d" /* drawCurrentGun */](ctx, this.currentGun);
    __WEBPACK_IMPORTED_MODULE_0__util_draw_util__["e" /* drawIcons */](ctx, this.images);
    __WEBPACK_IMPORTED_MODULE_0__util_draw_util__["f" /* drawControls */](ctx);
  }
