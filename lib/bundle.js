  ...
  checkCollisions() {
    ...
    missiles.forEach(missile => {
      if (missile.isCollidedWith()) {
        ...
        this.projectiles[this.projectiles.indexOf(missile)] = new __WEBPACK_IMPORTED_MODULE_3__rocket_explosion__["a" /* default */]({pos, color});
        this.shields -= 1;
      }
    });
  }
...
class Rocket {
  ...
  explode({pos, color}) {
    return new __WEBPACK_IMPORTED_MODULE_1__rocket_explosion__["a" /* default */]({pos, color});
  }
