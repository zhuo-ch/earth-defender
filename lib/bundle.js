...
class Game {
  ...
  drawIcons(ctx) {
    ...
    Object.keys(this.images).forEach(key => {
      switch (key) {
        case 'rocketIcon':
          ctx.drawImage(this.images.rocketIcon, 50, 420, 50, 40);
          break;
        case 'shotgunIcon':
          ctx.drawImage(this.images.shotgunIcon, 105, 425, 40, 30);
          break;
        case 'gravityGunIcon':
          ctx.drawImage(this.images.gravityGunIcon, 150, 420, 50, 40);
          break;
        case 'laserIcon':
          ctx.drawImage(this.images.laserIcon, 205, 425, 40, 30);
          break;
        default:
          break;
      }
...
class LaserExplosion {
  ...
  isCollidedWith(otherObj) {
    return __WEBPACK_IMPORTED_MODULE_0__util_util__["b" /* isCollidedWith */](this, otherObj);
  }
...
class Rocket {
  ...
  draw(ctx) {
    ...
    const vel = this.vel;
    const color = this.color;
    __WEBPACK_IMPORTED_MODULE_0__util_util__["c" /* drawProjectile */]({ctx, pos, vel, color});
  }
