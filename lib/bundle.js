...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rocket_explosion__ = __webpack_require__(7);
  ...
  checkCollisions() {
    ...
    missiles.forEach(missile => {
      if (missile.isCollidedWith()) {
        ...
        this.projectiles[this.projectiles.indexOf(missile)] = new __WEBPACK_IMPORTED_MODULE_3__rocket_explosion__["a" /* default */]({pos, game, color});
        this.shields -= 1;
      }
    });
  }
  ...
  draw(ctx) {
    ...
    this.projectiles.forEach((projectile, idx) => {
      if (projectile.endPos && (projectile.endPos[1] === projectile.pos[1])) {
        ...
        this.projectiles[idx] = this.projectiles[idx].explode({pos, game, color});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__rocket_explosion__ = __webpack_require__(7);
...
class Rocket {
  ...
  explode({pos, game, color}) {
    return new __WEBPACK_IMPORTED_MODULE_1__rocket_explosion__["a" /* default */]({pos, game, color});
  }
...
/* harmony default export */ __webpack_exports__["a"] = (RocketExplosion);
