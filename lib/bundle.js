...
class Game {
  ...
  addRocket(endPos) {
    ...
    this.missiles.push(new __WEBPACK_IMPORTED_MODULE_1__rocket__["a" /* default */]({pos, vel, endPos, game}));
  }
  ...
  draw(ctx) {
    ...
    this.missiles.forEach((projectile, idx) => {
      if (projectile.endPos && (projectile.endPos[1] === projectile.pos[1])) {
        ...
        const game = this
        this.missiles[idx] = new __WEBPACK_IMPORTED_MODULE_2__explosion__["a" /* default */]({pos, game});
